...
public static class PartsManager
{
    ...
    static readonly string BaseAddress = "https://mslearnpartsserver102924108.azurewebsites.net";
    ...
    public static async Task<IEnumerable<Part>> GetAll()
    {
        ...
        return JsonSerializer.Deserialize<IEnumerable<Part>>(result, new JsonSerializerOptions
        {
    ...
    public static async Task<Part> Add(string partName, string supplier, string partType)
    {
        ...
        var insertedPart = JsonSerializer.Deserialize<Part>(returnedObject, new JsonSerializerOptions
        {
            PropertyNameCaseInsensitive = true
        });
